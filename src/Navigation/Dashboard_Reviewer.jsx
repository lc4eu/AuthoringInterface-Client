    ...
    fetch('/api/update_status', {
      ...
      .then(response => {
        if (response.ok) {
          ...
          console.log('Field updated in the backend');
        } else {
          // Handle error case
          console.error('Failed to update field in the backend');
        }
      })
      .catch(error => {
        console.error('Error occurred while updating field in the backend:', error);
      });
  };
                                      ...
                                      <div className='modal'>
                                        ...
                                        <div>
                                          ...
                                          <div className="status_text" >
                                            <select class="status_sele" value={selectedOption} onChange={handleOptionChange}>
                                              <option class="status_op" value={dis.USR_status}>{dis.USR_status}</option>
                                              <option class="status_op" value="In Edit">In Edit</option>
                                              <option class="status_op" value="In Review">In Review</option>
                                              <option class="status_op" value="Approved" >Approved</option>
                                              {/* href={`http://localhost:9999/update_status?dis_id=${dis.discourse_id} s_value= Approved`} */}
                                            </select>
                                            <button onClick=
                                              {() => handleButtonClick()}>
                                              Update staus
