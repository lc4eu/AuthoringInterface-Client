...
//   const ddata = searchParams.get('data');
//   var array = JSON.parse("[" + ddata + "]");

//   const sendata = () => {
//     fetch(`/specific_sentence?disco_id=${did}`)
//       .then(response => {
//         return response.json()
//       })
//       .then(datasen => {
//         setMessage(datasen[0].sentences)
//         // console.log(datasen)
//         setShowIframe(true)
//       })
//   }
...
//   const discoursename = () => {
//     fetch(`/specific_discoursename?disco_id=${did}`)
//       .then(response => {
//         return response.json()
//       })
//       .then(datasen => {
//         setDiscourseName(datasen[0].discourse_name)
//         // console.log(datasen)
//         setShowIframe(true)
//       })
//   }
...
//   // useEffect(() => {
//   //   setMessage(array[0][0])
//   //   setDiscourseName(array[0][2])
//   //   let l_usr = []
//   //   for (var i = 0; i < array[0][3].length; i++) {
//   //     var s = array[0][3][i].replaceAll("\'", "\"")
//   //     let k = JSON.parse(s)
//   //     l_usr.push(k)
//   //   }
//   //   setShowIframe(true);
...
//           <iframe className="outl" width="500" height="540" title="sentence" src={`/sentences/?sentence=${sentences} & discourse_id=${did}`} />
//           {/* <div className="usrtop"><iframe className="usr_usrtop" width="994px" id="usr" height="540" title="usr" src={`/usredit?disco_id=${array[0][1]} & receivedindex=${receivedIndex}&discoursename=${discourse_name}&receivedItem=${receivedItem}`} /> </div> */}
//           <div className="usrtop"><iframe className="usr_usrtop" width="994px" id="usr" height="540" title="usr" src={`/usredit?disco_id=${did} & receivedindex=${receivedIndex}&discoursename=${discourse_name}&receivedItem=${receivedItem}`} /> </div>
...
//               state: {
//                 "disco_id": array[0][1],
//                 "usr_dis": array[0][3][receivedIndex]
//               }
//             }}
//           > */}
//           {/* </Link> */}
